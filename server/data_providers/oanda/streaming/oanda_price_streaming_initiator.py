...
from data_providers.shared.live_price_api_class import LivePriceApi
from data_providers.oanda.streaming.oanda_streaming_base_class import OandaStreamingBaseClass
...
class PriceStreamer(OandaStreamingBaseClass):
    ...
    def update_live_price(self, live_price: LivePriceApi):
        try:
